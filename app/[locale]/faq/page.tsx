cat > "app/[locale]/faq/page.tsx" << 'EOF'
"use client";
...
export default function FAQPage() {
  ...
  return (
    <main dir={isRtl ? "rtl" : "ltr"} style={{ background: "#0a0a0f", minHeight: "100vh", color: "#f0eee8", fontFamily: "sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "3rem 2rem" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          <div style={{ display: "inline-block", background: "#f5c842", color: "#000", fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", padding: "6px 16px", borderRadius: 4, marginBottom: "1.25rem" }}>FAQ</div>
        ...
        <div style={{ marginTop: "3rem", padding: "2rem", background: "#13131a", border: "0.5px solid rgba(245,200,66,0.2)", borderRadius: 16, textAlign: "center" }}>
          ...
          <a href="mailto:support@mysterydrop.eu" style={{ display: "inline-block", background: "#f5c842", color: "#000", padding: "10px 24px", borderRadius: 8, fontWeight: 700, fontSize: 14, textDecoration: "none" }}>support@mysterydrop.eu</a>
        </div>
      </div>
    </main>
  );
